...
function calculator() {
  ...
  const highlightOperator = (name) => {
    ...
    document
      ...
      .classList.remove("calc__btn--active");
  ...
  const activateButtons = () => {
    ...
    document
      ...
      .addEventListener("click", () => digitPressed(0));
    document
      .getElementById("btn-1")
      .addEventListener("click", () => digitPressed(1));
    document
      .getElementById("btn-2")
      .addEventListener("click", () => digitPressed(2));
    document
      .getElementById("btn-3")
      .addEventListener("click", () => digitPressed(3));
    document
      .getElementById("btn-4")
      .addEventListener("click", () => digitPressed(4));
    document
      .getElementById("btn-5")
      .addEventListener("click", () => digitPressed(5));
    document
      .getElementById("btn-6")
      .addEventListener("click", () => digitPressed(6));
    document
      .getElementById("btn-7")
      .addEventListener("click", () => digitPressed(7));
    document
      .getElementById("btn-8")
      .addEventListener("click", () => digitPressed(8));
    document
      .getElementById("btn-9")
      .addEventListener("click", () => digitPressed(9));
    ...
    document
      ...
      .addEventListener("click", () => operatorPressed("plus"));
    document
      .getElementById("btn-minus")
      .addEventListener("click", () => operatorPressed("minus"));
    document
      .getElementById("btn-multiply")
      .addEventListener("click", () => operatorPressed("multiply"));
    document
      .getElementById("btn-divide")
      .addEventListener("click", () => operatorPressed("divide"));
    ...
    document
      ...
      .addEventListener("click", () => memoryPlusPressed());
    document
      .getElementById("btn-mminus")
      .addEventListener("click", () => memoryMinusPressed());
    document
      .getElementById("btn-m")
      .addEventListener("click", () => memoryRecallPressed());
    document
      .getElementById("btn-mc")
      .addEventListener("click", () => memoryClearPressed());
  };
